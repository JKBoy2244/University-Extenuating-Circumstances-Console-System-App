...
class Year3ModuleSelect extends YearGroup implements Year {

  private String module;

  public Year3ModuleSelect(String option, String module) {
  ...
  public static void selectModule(String studID, String option) {
    ...
    while (maxAttempts != 0) {
      ...
      System.out.println("Enter your chosen 3rd year module in the year3Modules.txt to write your EC about!");
      ...
      try {
        ...
        File file = new File("year3Modules.txt");
