...
class Year1ModuleSelect extends YearGroup implements Year {

  private String module;

  public Year1ModuleSelect(String option, String module) {
  ...
  public static void selectModule(String studID, String option) {
    ...
    while (maxAttempts != 0) {
      ...
      System.out.println("Enter your chosen 1st year module in the year1Modules.txt to write your EC about!");
      ...
      try {
        ...
        File file = new File("year1Modules.txt");
